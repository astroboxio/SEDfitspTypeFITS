...
class _GCPD:
    ...
    def print_data(self,target,references=True):
        h=self.fetch_data(target)
...
class _GCPD_Photometry_Walraven(_GCPD):
    """ Walraven photometry.
    Does J belongs here? There is V-J index....
    ...
    M   HD210934 0.573 0.05 # Walraven V
    M   HD210934 0.575 0.05 # Walraven V
    M   HD210934 0.581 0.05 # Walraven V
    M   HD210934 0.581 0.05 # Walraven V
    M   HD210934 0.613 0.05 # Walraven B
    M   HD210934 0.6133 0.05 # Walraven B
    M   HD210934 0.613 0.05 # Walraven B
    M   HD210934 0.6202 0.05 # Walraven B
    M   HD210934 0.623 0.05 # Walraven B
    M   HD210934 0.547 0.05 # Walraven L
    M   HD210934 0.5486 0.05 # Walraven L
    M   HD210934 0.551 0.05 # Walraven L
    M   HD210934 0.5554 0.05 # Walraven L
    M   HD210934 0.557 0.05 # Walraven L
    M   HD210934 0.382 0.05 # Walraven U
    M   HD210934 0.3822 0.05 # Walraven U
    M   HD210934 0.388 0.05 # Walraven U
    M   HD210934 0.386 0.05 # Walraven U
    M   HD210934 0.391 0.05 # Walraven U
    M   HD210934 0.34 0.05 # Walraven W
    M   HD210934 0.3402 0.05 # Walraven W
    M   HD210934 0.344 0.05 # Walraven W
    M   HD210934 0.3436 0.05 # Walraven W
    M   HD210934 0.35 0.05 # Walraven W
    """
...
def main(argv=None):
    ...
    try:
        try:
            opts, args = getopt.getopt(argv[1:], "h", ["help","target=","system=","test","systemlist"])
